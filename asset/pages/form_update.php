			...
			<div class="container"> 
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="pages/profil.php" class="page-scroll">Profile</a></li>
...
<!-- Header -->
    ...
    <section class="edit-profil">
        ...
        <aside id="leftsidebar" class="sidebar">
            <!-- User Info -->
            <div class="user-info card img-edit">
                <div class="image">
                    <?php
						include "koneksi.php";
						$dir='../img/profile/';
						...
						if(empty($cdata['urlfoto'])){
						 ...
						 echo "<a href='".$cdata['urlfoto']."'><img src='".$cdata['urlfoto']."'width='100' height='100' class='img-profile'> </a>";
						}
					?>
							...
							<form action="proses_update.php" enctype="multipart/form-data" method="post">
								<input type="hidden" name="id" value="<?php echo $id;?>">
									<div class="form-group form-float">
										<div class="form-line">
										<label class="form-label label-profile">Nama</label>
											<input type="text" name="nama" class="form-control" value="<?php echo $data['nama'];?>" required/>
										</div>
									</div>
									<div class="form-group form-float">
										<div class="form-line">
											<label class="form-label label-profile">NISN</label>
											<input type="text" name="nisn" class="form-control" value="<?php echo $data['nisn'];?>" required/>
										</div>
									</div>
									<div class="form-group form-float">
										<div class="form-line">
											<label class="form-label label-profile">Kelas</label>
											<input type="text" name="kelas" class="form-control" value="<?php echo $data['kelas'];?>" required/>
										</div>
									</div>
								 <div class="form-group form-float">
									<div class="form-line">
										<label class="form-label label-profile">Jurusan</label>
										<input type="text" name="jurusan" class="form-control" value="<?php echo $data['jurusan'];?>" required/>
									</div>
								</div>
								 <div class="form-group form-float">
										<div class="form-line">
											<label class="form-label label-profile">Alamat</label>
											<input type="text" name="alamat" class="form-control" value="<?php echo $data['alamat'];?>" required/>
										</div>
									</div>
								 <div class="form-group form-float">
									<div class="form-line">
										<label class="form-label label-profile">No. Hp</label>
										<input type="text" name="nohp" class="form-control" value="<?php echo $data['nohp'];?>" required/>
									</div>
								</div>
								<div class="form-group form-float">
									<div class="form-line"><br><br>
										<label class="form-label label-profile">Foto</label>
										<?php echo "<a href='".$data['urlfoto']."'><img src='".$data['urlfoto']."'width='100' height='100' class='img-upload'>";?>
										<input type="file" name="foto"  class="form-control" value="<?php echo $data['foto'];?>"/>
									</div>
								</div> <br>
								<input type="submit" name="submit" class="btn btn-primary m-t-15 waves-effect btn-action"></input>
								<a href="profil.php">
									<button type="reset" name="reset" class="btn btn-primary m-t-15 waves-effect btn-action">Reset</button>
								</a>
								<a href="profil.php">
									<button type="submit" name="cancel" class="btn btn-primary m-t-15 waves-effect btn-action">Cancel</button>
								</a>
                            </form>
                        </div>
                    </div>
 ...
 ?>
							<form action="proses_update_akun.php" enctype="multipart/form-data" method="post">
								<input type="hidden" name="id" value="<?php echo $id;?>">
									<div class="form-group form-float">
										<div class="form-line">
										<label class="form-label label-profile">Username</label>
											<input type="text" name="username" class="form-control" value="<?php echo $_SESSION['username'];?>" required/>
										</div>
									</div>
									<div class="form-group form-float">
										<div class="form-line">
											<label class="form-label label-profile">Password</label>
											<input type="text" name="password" class="form-control" placeholder="Password tidak bisa diganti , harap hubungi Admin terlebih dahulu" disabled/>
										</div>
									</div>
								  <br>
								<input type="submit" name="submit" class="btn btn-primary m-t-15 waves-effect btn-action"></input>
