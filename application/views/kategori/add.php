			...
			<div class="row">
				<div class="col-md-12">
					<div class="profile-admin">
						<h1>Input Data</h1>
						<form action="<?php echo base_url(); ?>index.php/kategori/action_add" method="post" class="card">
							<p class="label-edit-profile">Kategori :</p>
							<input type="text" name="kategori" placeholder="Masukkan Kategori" class="form-group-add" required><br>
