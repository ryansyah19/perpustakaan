...
<body class="login-page">
    <div class="login-box">
        <div class="logo zoomIn">
            <a href="javascript:void(0);"><b>Password Anda</b></a>
        ...
        <div class="card-login zoomIn">
            ...
            <?php echo form_open('welcome/auth'); ?>
                    <div class="msg">Password Anda sudah dikirim oleh Admin melalui alamat 
                                     Email anda
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <a href="https://mail.google.com" class="w3-btn w3-block cek-email">Cek Email</a>
                            <a href="<?php echo base_url(); ?>index.php/welcome/" class="w3-btn w3-block cek-email">Beranda</a>
                        </div>
                    </div>
                <?php echo form_close(); ?>
            </div>
