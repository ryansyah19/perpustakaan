				...
				<div class="col-md-12">
					<div class="profile-admin">
						...
						<?php foreach ($content->result() as $key): ?>
							<form action="<?php echo base_url(); ?>index.php/crud/action_update_denda/<?php echo $key->id ?>" method="post" class="card">
								<p class="label-edit-profile">Denda :</p>
								<input type="text" name="denda" placeholder="Masukkan Denda" value="<?php echo $key->denda ?>" class="form-group-add"><br>
								<input type="submit" value="Save" class=" w3-btn link-action-delete">
								<input type="button" value="Cancel" class=" w3-btn link-action-delete" onclick="javascript:window.location='<?php echo site_url('peminjaman/') ?>';">
							</form>
						<?php endforeach ?>
					</div>
				</div>
