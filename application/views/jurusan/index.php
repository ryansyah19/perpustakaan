...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
	<!-- Navigation -->
					...
					<div class="container">
						<div class="row">
							<div class="intro-text">
								<h1 class="label-admin">Halaman Admin | CRUD Jurusan</h1>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="profile-admin">
			...
			<a href="<?php echo base_url(); ?>index.php/jurusan/add" class="w3-btn create-admin">Create</a>
			<table border="1" class="tabel-admin" id="customers">
				...
				<?php foreach ($content->result() as $key): ?>
					<tr>
						...
						<td>
							<a href="<?php echo base_url() ?>index.php/jurusan/read/<?php echo $key->id ?>" class="w3-btn  link-action-read">Detail</a>
							<a href="<?php echo base_url() ?>index.php/jurusan/update/<?php echo $key->id ?>" class=" w3-btn link-action-update">Edit</a>
							<a href="<?php echo base_url() ?>index.php/jurusan/delete/<?php echo $key->id ?>" class=" w3-btn link-action-delete">Delete</a>
						</td>
					</tr>	
				<?php endforeach ?>	
			</table>
