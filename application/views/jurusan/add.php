					...
					<div class="container">
						<div class="row">
							<div class="intro-text">
								<h1 class="label-admin">Halaman Admin | Input Data Jurusan</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="profile-admin">
						<h1>Input Data</h1>
						<form action="<?php echo base_url(); ?>index.php/jurusan/action_add" method="post" class="card">
							<p class="label-edit-profile">Jurusan :</p>
							<input type="text" name="jurusan" placeholder="Masukkan Jurusan" class="form-group-add" required><br>
