				...
				<div class="col-md-12">
					<div class="profile-admin">
						...
						<form action="<?php echo base_url(); ?>index.php/crud/action_add" method="post" class="card">
							...
							<select name="status" placeholder="Masukkan Status" class="form-group-add" required>
							  <option value="Empty">-----</option>
							  <option value="Siswa">Siswa</option>
							  <option value="Guru">Guru</option>
							</select><br>
							<p class="label-edit-profile">Jurusan :</p>
							<select name="jurusan" placeholder="Masukkan Jurusan Anda" class="form-group-add" required>
							...
							<select name="kelas" class="form-group-add" required>
							  <option value="Empty">-----</option>
							...
							<input type="text" name="noinduk" placeholder="Masukkan No Induk / No Guru" class="form-group-add" required><br>
							<p class="label-edit-profile">No Telepon :</p>
							<input type="text" name="notelp" placeholder="Masukkan No Telepon" class="form-group-add" required><br>
							<p class="label-edit-profile">Username :</p>
							<input type="text" name="username" placeholder="Masukkan username" class="form-group-add" required><br>
							...
							<p class="label-edit-profile">Level :</p>
							<select name="level" class="form-group-add" required>
							  <option value="Empty">-----</option>
