				...
				<div class="col-md-12">
					<div class="profile-admin">
						...
						<?php foreach ($content->result() as $key): ?>
							<form action="<?php echo base_url(); ?>index.php/crud/action_update_admin/<?php echo $key->id ?>" method="post" class="card">
								...
								<input type="text" name="username" placeholder="Masukkan Username" value="<?php echo $key->username ?>" class="form-group-add"><br>
