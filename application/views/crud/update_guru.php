				...
				<div class="col-md-12">
					<div class="profile-admin">
						...
						<?php foreach ($isi->result() as $key): ?>
							<form action="<?php echo base_url(); ?>index.php/crud/action_update_guru/<?php echo $key->id ?>" method="post" class="card">
								<p class="label-edit-profile">NIP :</p>
								<input type="text" name="nip" placeholder="Masukkan NIS" value="<?php echo $key->nip ?>" class="form-group-add"><br>
								...
								<select name="mapel" placeholder="Masukkan Mapel" value="<?php echo $key->mapel ?>" class="form-group-add">
