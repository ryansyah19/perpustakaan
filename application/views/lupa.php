...
<body class="login-page">
    <div class="login-box">
        <div class="logo zoomIn">
            <a href="javascript:void(0);"><b>Lupa Password</b></a>
            <img src="<?php echo base_url() ?>asset/img/icons/grf.png" class="img-login">
        </div>
        <div class="card-login zoomIn">
            <div class="body" id="body">
            <?php echo form_open('welcome/action_lupa'); ?>
                    <div class="msg">Masukkan Data Diri</div>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="material-icons">person</i>
                        </span>
                        <div class="form-line">
                            <input type="text" class="form-control" name="username" placeholder="No. Induk" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="lengkap" placeholder="Nama Lengkap" required>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
