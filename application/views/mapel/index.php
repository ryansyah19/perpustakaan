...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
	<!-- Navigation -->
					...
					<div class="container">
						<div class="row">
							<div class="intro-text">
								<h1 class="label-admin">Halaman Admin | CRUD Mapel</h1>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="profile-admin">
			<h1>Data Mapel</h1><hr>
			<a href="<?php echo base_url(); ?>index.php/mapel/add" class="w3-btn create-admin">Create</a>
			<table border="1" class="tabel-admin" id="customers">
				...
				<?php foreach ($isi->result() as $key2): ?>
					<tr>
						...
						<td>
							<a href="<?php echo base_url() ?>index.php/mapel/read/<?php echo $key2->id ?>" class="w3-btn  link-action-read">Detail</a>
							<a href="<?php echo base_url() ?>index.php/mapel/update/<?php echo $key2->id ?>" class=" w3-btn link-action-update">Edit</a>
							<a href="<?php echo base_url() ?>index.php/mapel/delete/<?php echo $key2->id ?>" class=" w3-btn link-action-delete">Delete</a>
						</td>
					</tr>	
				<?php endforeach ?>	
			</table>
